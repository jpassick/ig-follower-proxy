export default async function handler(req, res) {
  ...
  const html = `
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:0 auto;padding:2rem;">
      ...
      <p style="font-size:12px;color:#aaa;margin-top:1.5rem;">Auto-generated by Alamo IG Tracker · <a href="https://ig-follower-proxy.vercel.app" style="color:#aaa;">View dashboard</a></p>
    </div>`;
