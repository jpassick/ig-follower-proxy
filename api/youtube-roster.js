// Standalone YouTube roster: GET list, POST add+fetch, DELETE remove, PATCH update.
// Reads/writes Redis key `youtube-roster`.

const REDIS_KEY = 'youtube-roster';
const SMM_PATH = '/youtube-channel-details';
const SMM_WRAPPER = 'channel';
const PROFILE_URL = (handle) => `https://www.youtube.com/@${handle}`;
