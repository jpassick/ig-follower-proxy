// Standalone Twitter/X roster: GET list, POST add+fetch, DELETE remove, PATCH update.
// Reads/writes Redis key `twitter-roster`.

const REDIS_KEY = 'twitter-roster';
const SMM_PATH = '/twitter-user-account';
const SMM_WRAPPER = 'profile';
const PROFILE_URL = (handle) => `https://x.com/${handle}`;
