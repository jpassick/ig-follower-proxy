// Standalone TikTok roster: GET list, POST add+fetch, DELETE remove, PATCH update.
// Reads/writes Redis key `tiktok-roster`.

const REDIS_KEY = 'tiktok-roster';
const SMM_PATH = '/tiktok-user-account';
